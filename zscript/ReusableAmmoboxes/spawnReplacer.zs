...
class ReusableAmmoboxesSpawner : EventHandler {
    ...
    void init() {
        ...
        // 20mm Grenades
        Array<string> wep_20mm;
        wep_7mm.push('WAN_MA76C');
        addAmmo('Reusable20mmGrenadeBox', wep_20mm);
        ...
        addItem('HD355BoxPickup',  'Reusable355Box',    'HDRevolverAmmo', 10, 'TEN3A0', '3RNDA0');
